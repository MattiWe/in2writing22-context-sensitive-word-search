...
def _mean_ndgc(predictions, truth, top_n=30):
    def _get_ndgc(qid, tr):
        ranking = predictions[qid].get('rel3', []) + predictions[qid].get('rel2', []) + predictions[qid].get('rel1',
                                                                                                             [])[:top_n]
        # deduplicate
        ranking = _clean_ranking(ranking)
    ...
    return _get_mean([_get_ndgc(k, v) for k, v in truth.items()])
...
def evaluate(output_path: Path, test_dataset_path: Path, netspeak_results_path: Path,
    ...
    for mrp in model_result_paths:
        ...
        mr[name] = {
            ...
            'ndcg': [_mean_ndgc(predictions_model_only_netspeak, truth_only_netspeak, 1),
                     _mean_ndgc(predictions_model_only_netspeak, truth_only_netspeak, 2),
                     _mean_ndgc(predictions_model_only_netspeak, truth_only_netspeak, 3),
                     _mean_ndgc(predictions_model_only_netspeak, truth_only_netspeak, 4),
                     _mean_ndgc(predictions_model_only_netspeak, truth_only_netspeak, 5),
                     _mean_ndgc(predictions_model_only_netspeak, truth_only_netspeak, 10),
                     _mean_ndgc(predictions_model_only_netspeak, truth_only_netspeak, 15),
                     _mean_ndgc(predictions_model_only_netspeak, truth_only_netspeak, 20),
                     _mean_ndgc(predictions_model_only_netspeak, truth_only_netspeak, 25),
                     _mean_ndgc(predictions_model_only_netspeak, truth_only_netspeak, 30),
                     ]
...
if __name__ == "__main__":
    tp = Path("/mnt/ceph/storage/data-in-progress/data-research/netspeak/in2writing22-lcwp/test-datasets")
    ...
    evaluate(op, tp / "cloth-test.ndjson", tp / 'netspeak3-cloth-test.ndjson',
             [pp / 'cloth-test-mlm.ndjson', pp / 'cloth-test-mlm-finetuned.ndjson',
              pp / 'cloth-test-bart.ndjson', pp / 'cloth-test-bart-finetuned.ndjson',
              pp / 'cloth-test-mlm-ft-netspeak.ndjson'], 3)
    evaluate(op, tp / "cloth-test.ndjson", tp / 'netspeak5-cloth-test.ndjson',
             [pp / 'cloth-test-mlm.ndjson', pp / 'cloth-test-mlm-finetuned.ndjson',
              pp / 'cloth-test-bart.ndjson', pp / 'cloth-test-bart-finetuned.ndjson',
              pp / 'cloth-test-mlm-ft-netspeak.ndjson'], 5)
    evaluate(op, tp / "wikitext-test.ndjson", tp / 'netspeak3-wikitext-test.ndjson',
             [pp / 'wikitext-test-mlm.ndjson', pp / 'wikitext-test-mlm-finetuned.ndjson',
              pp / 'wikitext-test-bart.ndjson', pp / 'wikitext-test-bart-finetuned.ndjson',
              pp / 'wikitext-test-mlm-ft-netspeak.ndjson'], 3)
    evaluate(op, tp / "wikitext-test.ndjson", tp / 'netspeak5-wikitext-test.ndjson',
             [pp / 'wikitext-test-mlm.ndjson', pp / 'wikitext-test-mlm-finetuned.ndjson',
              pp / 'wikitext-test-bart.ndjson', pp / 'wikitext-test-bart-finetuned.ndjson',
              pp / 'wikitext-test-mlm-ft-netspeak.ndjson'], 5)
